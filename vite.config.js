...
export default defineConfig({
	...
	rollupOptions: {
		...
		blog4: resolve(__dirname, 'blogs/discontinuous-galerkin-method-from-scratch-in-python-gmsh.html'),
		blog5: resolve(__dirname, 'blogs/discontinuous-galerkin-method-from-scratch-in-python-mapping-reference-to-physical.html'),
	    },
    },
  },
})
